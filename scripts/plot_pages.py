...
plt.text(10, 0.85*ymax, r"JBros's thesis")
...
if calendar:
    ...
    plt.text((datetime.datetime.strptime("2015-05-04-00h00m00s", "%Y-%m-%d-%Hh%Mm%Ss") - start).days, -15, r"May")
    plt.text((datetime.datetime.strptime("2015-06-04-00h00m00s", "%Y-%m-%d-%Hh%Mm%Ss") - start).days, -15, r"June")
    # plt.text((datetime.datetime.strptime("2015-07-04-00h00m00s", "%Y-%m-%d-%Hh%Mm%Ss") - start).days, -15, r"July")
    # plt.text((datetime.datetime.strptime("2015-08-04-00h00m00s", "%Y-%m-%d-%Hh%Mm%Ss") - start).days, -15, r"Aug")
    # plt.text((datetime.datetime.strptime("2015-09-04-00h00m00s", "%Y-%m-%d-%Hh%Mm%Ss") - start).days, -15, r"Sept")
