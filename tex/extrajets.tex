...
\caption{Distributions of minimum reconstructed $\Delta R$ betweeen extra jets in simulation and data for (Na) the first, (b) second, (c) third and (d) fourth extra jet. }
\label{fig:recodr}
\end{figure}
\begin{figure}
\centering
